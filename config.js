module.exports = {
  ...
  adminId: "552086701095387137", //- Replace UserId with the Discord ID of the admin of the bot
  ...
  nodes: [
    {
      ...
      host: "lava-all.ajieblogs.eu.org" || "lavalink.serenetia.com", //- The host name or IP of the lavalink server.
