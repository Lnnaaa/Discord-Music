...
const command = new SlashCommand()
  ...
  .addChannelOption((option) =>
    option
      .setName("channel")
      .setDescription("🏠 Select the channel where welcome messages will appear.")
      .setRequired(true)
  )
  .setRun(async (client, interaction) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `✨ From now on, all new members will be welcomed in ${channel}!\n\n` +
      ...
      return interaction.reply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription("We couldn't set the welcome channel. Please try again later!"),
        ],
        ephemeral: true,
      });
    }
